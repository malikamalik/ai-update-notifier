  ...
  return (
    <div className="flex flex-wrap gap-2">
      <button
        ...
        className={`px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-150 cursor-pointer border ${
          activeFilter === "all"
      ...
      {visibleProviders.map(([key, provider]) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-150 cursor-pointer border ${
              isActive
